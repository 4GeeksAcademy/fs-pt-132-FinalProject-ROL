...
// Etiquetas para los estados de juego
const STATUS_LABELS = {
...
export const Profile = () => {
  ...
  // Al montar, traer datos del usuario desde el backend
  useEffect(() => {
    if (!store.user?.id) {
      setLoading(false);
  ...
  return (
    <div className="container py-4">
      ...
      {/* Estadísticas: juegos, comentarios, favoritos */}
        ...
        <div className="card-body">
          {userGames.length === 0 ? (
            ...
            <div className="text-center py-4">
              <p className="text-muted mb-3">No tienes juegos registrados a\u00fan.</p>
              <Link to="/" className="btn btn-outline-primary">Explorar juegos</Link>
            </div>
          ) : (
            // Grilla de juegos
