...
export const Signup = () => {
  // Store global: leemos isAuthenticated para redirigir si ya está logueado
  ...
  const navigate = useNavigate();
   ...
   const [loading, setLoading] = useState(false) // true  mientras se envia

   // Actualiza  uncampo  y limpia su error
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Registro exitoso: redirige a Login con mensaje
      navigate("/login", {
        ...
        <div className="col-md-6 col-lg-5">
          <div className="card shadow-sm">
            <div className="card-body p-4">
              ...
              <p className="text-muted text-center mb-4">Join Game-Side today</p>
