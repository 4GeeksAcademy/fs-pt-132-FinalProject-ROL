		...
		<section className="bg-dark text-white text-center py-5">
			<div className="container">
				{store.isAuthenticated && store.user && (
					<p className="fs-5 text-primary mb-2">Bienvenido de vuelta,{store.user.username}!</p>
				)}
	...
	const SurveyCTASection = () => (
		<section className="bg-light py-5">
			<div className="container text-center">
				<h2 className="mb-3">
					Tu próximo descubrimiento está aquí
				</h2>
				<p className="text-muted mb-5">
					Responde unas preguntas rápidas y recibe recomendaciones
					hechas para ti.
				</p>
						...
						<div className="card h-100 shadow-sm">
							<div className="card-body">
								...
								<p className="card-text text-muted">
									Recibe recomendaciones basadas en tus géneros, estilo
					...
					<div className="col-md-4">
						<div className="card h-100 shadow-sm">
							<div className="card-body">
								...
								<p className="card-text text-muted">
									Deja de perder horas buscando y encuentra títulos que
			...
			<section className="py-5 bg-light">
				<div className="container">
					...
					{games.length > 0 ? (
						...
						<div className="text-center py-5">
							<h4 className="text-muted">No hay recomendaciones aún</h4>
							<p>
